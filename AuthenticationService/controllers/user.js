...
const { activeAccountEmail, forgotPasswordEmail } = require("../helpers/mailer");
...
exports.Signup = async(req, res) => {
    try {
        ...
        const sendCode = await activeAccountEmail(result.value.email, code);
...
exports.ForgotPassword = async(req, res) => {
    try {
        ...
        let response = await forgotPasswordEmail(user.email, code);
